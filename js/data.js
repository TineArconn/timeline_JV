...
const GAMES = [
  ...
  { year:1993, slug:"maniac-mansion-day-of-the-tentacle",
    ...
    opinion:"Années 90 oblige, il faut un point & click dans cette liste. Le choix est très dur, entre un The Secret of Monkey Island au combat d'insultes cultissime, un Indiana Jones and the Fate of Atlantis qui propose 3 styles de jeux et une rejouabilité exceptionnelle pour un point & click, ou encore un Woodruff and the Schnibble of Azimuth avec son scénario singulier et son doublage soigné. Mais s'il n'en fallait garder qu'un, cela ne pourrait être que le titanesque Day of the Tentacle : son humour absurde intemporel, ses voyages dans le temps réellement intégrés au gameplay, ses graphismes cartoon qui ont magnifiquement vieilli. Surtout, ses énigmes \"à l\'ancienne\" offrent une satisfaction immense au moment où l'on finit par trouver la solution. N'importe qui ayant joué à ce jeu se souviendra de l'énigme du hamster ou de comment libérer Laverne bloquée dans son arbre ! Bref, un classique de chez classique, qui se joue à tout âge, et qui mérite amplement sa place dans ma ludothèque. Hâte d'y rejouer avec mes enfants quand ils grandiront, sans doute dans sa version remasterisée." },
  ...
  { year:1995, slug:"chrono-trigger-1995",
    ...
    opinion:"Chrono Trigger est considéré par beaucoup comme un des meilleurs RPG de tous les temps, et cette réputation n'est pas volée ! Non seulement le titre perfectionne des mécaniques déjà existantes comme le système Active Time Battle (ATB) créé pour Final Fantasy 4 à l'origine, mais il innove le genre en proposant des combats non aléatoires directement dans la zone de jeu, les attaques combinées entre personnages, douze fins uniques et même le New Game + ! Son scénario ne se résume pas au classique \"le bien contre le mal\", mais aborde également le destin et l'écologie dans un univers unique divisé en six époques. Les graphismes sont magnifiques et exploitent une SNES en fin de vie. Et que dire de l'OST, simplement sublime avec ses 64 titres variés, composés en grande partie par un Yasunori Mitsuda à ses débuts, épaulé par Nobuo Uematsu lorsque la fatigue l'a contraint à s'arrêter ! Le cri de Lavos hante encore les joueurs, et des morceaux comme \"Battle with Magus\", \"Last Battle\" ou encore \"Chrono Trigger\" sont des chefs-d'œuvre. Bref, un coup de cœur, qui avait été traduit en français à l'époque par les bénévoles de Terminus Traduction, qu'il convient de saluer ici !"},
  ...
  { year:1997, slug:"theme-hospital",
    ...
    desc:"Gérez un hôpital peuplé de maladies absurdes — Grosse Tête à éclater, Hyperlangue à raccourcir, complexe d'Elvis à désamorcer. L'humour britannique décapant de Bullfrog en fait un jeu de gestion culte et toujours aussi savoureux.",
    opinion:"À bien regarder ma frise, on constate que pas moins de cinq jeux auxquels Peter Molyneux et Bullfrog Productions ont participé y sont présents. Deux figurent même dans mon top 10. Commençons par le plus ancien, mais aussi l'un des jeux les plus drôles auxquels j'ai pu jouer, j'ai nommé Theme Hospital. Un jeu de management facile à prendre en main, combiné avec un humour absurde rare dans le genre. On se souvient sans peine des maladies inventées toutes plus folles les unes que les autres : l'Hyperlangue à raccourcir au taille-langue, ou encore la Grosse Tête à éclater puis à regonfler à la bonne taille. Et que dire des annonces de l'accueil, devenues cultes : « Les patients sont priés d'être patients » ou même « Les patients sont priés de ne pas mourir dans les couloirs ». Trois décennies plus tard, elles restent gravées en mémoire. Tout comme reste en mémoire, pour de moins bonnes raisons cette fois, le fameux bug du niveau 5 qui empêchait de finir le jeu !  Cela n'a en rien entamé son statut culte. Maintenu jouable par la communauté et GOG, il a même connu une suite spirituelle vingt ans plus tard : Two Point Hospital, conçu par une nouvelle équipe en partie d'anciens de Bullfrog. Aujourd'hui, j'y rejoue toujours avec le même plaisir. Et l'humour s'est même transmis à mon garçon, qui rigole de bon cœur en construisant son hôpital. Preuve, s'il en fallait une, que certains rires ne vieillissent jamais."},
  ...
  { year:1998, slug:"populous-the-beginning",
    ...
    opinion:"Le dernier grand titre du studio Bullfrog, et le deuxième dans cette liste. Populous: The Beginning, troisième opus de la série, nous propose un chant du cygne mémorable. En effet, Peter Molyneux avait quitté Bullfrog l'année précédente pour fonder Lionhead, futur studio derrière Black & White, Fable ou encore The Movies. Quant à Bullfrog Productions, il sera tout simplement dissous par EA, tuant au passage la série. Prenez le contrôle d'une tribu et de sa chamane, et partez anéantir vos ennemis à coups de sorts magiques tous plus dangereux les uns que les autres. Tornade, éclair, volcan et même l'Armageddon, tout est fait pour vous faire vous sentir tel un dieu. La force du titre réside dans son terraforming rarement égalé à ce jour ! On éprouve une joie assez sadique lorsque l'on engloutit le village ennemi dans les eaux, simplement par érosion. Ou lorsque l'on combine les sorts \"Pont\" et \"Marécage\" pour forcer l'ennemi à passer par un pont que l'on a piégé. Bloqué dans ma jeunesse au niveau de l'Ange de la mort, j'ai finalement pu achever le jeu 20 ans après sa sortie, grâce à une communauté forte et encore vivante. Alors oui, les textures ont vieilli, oui la 3D est d'époque, mais le plaisir est toujours intact. Reste plus qu'une chose à dire : Taakaa !"},
  ...
  { year:2000, slug:"zeus-master-of-olympus",
    ...
    opinion: "Le jeu de gestion est clairement un de mes styles de jeu préférés. Choix difficile tant les sous-genres existent : God Game à la Populous, jeu de stratégie au tour par tour comme Civilization V qui vous entraîne dans des nuits blanches, ou même gestion d'un hôpital loufoque avec Theme Hospital. Mais un sous-genre règne en maître : le City Builder, et qui de mieux que Sierra et Impressions Games pour représenter le genre ? Mon coup de cœur à moi, grand fan de la mythologie grecque, reste Zeus : le maître de l'Olympe et son extension Poséidon, qui nous permet de bâtir rien de moins que l'Atlantide, tout en participant aux aventures des héros de l'Antiquité, qui résident dans notre cité et vont combattre les dieux et créatures hostiles. La première fois que Méduse est entrée dans ma ville reste un souvenir douloureux ! Les scénarios suivent, entre autres, l'histoire d'Athènes, l'enlèvement d'Europe par Zeus ou encore la guerre de Troie. Le gameplay reste semblable aux autres jeux de la licence : satisfaire les besoins de notre population, bâtir une économie par l'activité industrielle et les postes de commerce, faire la diplomatie ou la guerre. Le titre reste sans doute plus accessible que Caesar 3 ou Pharaon. Rares sont les années sans relancer une petite partie pour le plaisir, et ce dernier est désormais partagé, mon garçon en étant maintenant mordu lui aussi !"},
  ...
  { year:2003, slug:"castlevania-aria-of-sorrow-2",
    ...
    opinion:"Aria of Sorrow est pour moi le meilleur Castlevania, et un des meilleurs Metroidvania de ces 30 dernières années. On retrouve une direction artistique léchée dans un level design toujours parfait. La progression est très bien dosée, entre expérience à gagner, niveau à augmenter et armes à récupérer. Mais le grain de sel qui fait toute la différence avec les autres épisodes de la série, ainsi qu'avec d'autres titres comparables, est son système d'acquisition d'âmes : combattez les monstres, récupérez leur âme, et obtenez leur pouvoir en l'équipant ! On retrouve alors quatre classes d'âmes : rouge pour les attaques actives, bleue pour les sorts maintenus, jaune pour les bonus passifs, et grise pour les capacités de traversée qui permettront d'atteindre de nouveaux endroits sur la carte. On touche là à un des gros points forts du jeu : finir le jeu en ligne droite n'est pas la meilleure façon de faire, et l'exploration est encouragée naturellement, sans artifice ! Le meilleur étant que seuls ceux qui prendront le temps de bien visiter le château de Dracula pourront obtenir la vraie fin du jeu. On ne peut pas passer non plus à côté de l'OST de Michiru Yamane, déjà à la manœuvre sur Symphony of the Night, ou des bruitages dans leur ensemble. Confiné à la GBA, ce titre est parfait pour des sessions courtes, ce qui en fait un des meilleurs titres de cette console. Incontournable pour tout amateur de Metroidvania !"},
  ...
  { year:2006, slug:"okami",
    ...
    opinion:"Ōkami est sans aucun doute le plus beau jeu auquel il m'a été donné de jouer. Sa direction artistique est indémodable, hommage assumé aux estampes ukiyo-e et aux lavis sumi-e qui irriguent l'univers du jeu. Mais s'arrêter à son identité visuelle serait un crime, tant le titre est bourré de qualités. Son gameplay tout d'abord, proposant le pinceau céleste, un système de dessins magiques à peindre soi-même pour agir sur le décor, les énigmes et les combats. On se retrouve alors à faire fleurir un arbre en y peignant un cercle, ou invoquer le vent en quelques traits bien tracés. Soigner l'arbre de la forêt Agata et voir l'explosion de couleurs qui vient nous frapper à la figure reste un moment mémorable. Son histoire ensuite, combinant mythologie et folklore japonais, et qui nous amène à jouer la déesse du soleil, Amaterasu, sous la forme d'une louve blanche. Malgré des critiques dithyrambiques, Ōkami fut un échec commercial à sa sortie, et Clover Studio, qui était derrière ce projet, a été dissous peu après. Aujourd'hui pourtant, son aura lui a valu une version HD, et une suite a même été annoncée. Heureux possesseur d'une des rares 10 000 copies de la version PlayStation 2 distribuées en France, je ne risque pas de m'en séparer !"},
  ...
  { year:2008, slug:"kings-bounty-the-legend",
    ...
    opinion:"Ma pépite cachée, tout simplement. Lorsque l'on parle de jeu de stratégie tour par tour développé par New World Computing, les connaisseurs citeront à juste titre l'iconique Heroes of Might and Magic 3. Son système de combat et de gestion a marqué toute une génération, et on le retrouve très régulièrement en tête des ventes sur GOG. Mais peu de gens savent que ce système de combat vient d'une autre licence du même développeur : King's Bounty ! Imaginez-vous balader librement sur la carte du monde en temps réel, combattre qui vous souhaitez, faire les quêtes de vos choix : bref, un open-world... en 1990 ! King's Bounty: The Legend reprend le mécanisme en passant par la moulinette des Russes de Katauri Interactive. La première chose qui marque quand on lance le jeu, c'est qu'il est particulièrement beau ! Sa DA, poussant les couleurs sur un thème de contes de fées, est encore aujourd'hui très plaisante à regarder. La deuxième chose, c'est sa liberté : les quêtes peuvent être résolues généralement de plusieurs manières, et il n'est pas rare de tomber sur des ennemis très difficiles dès le début du jeu, avec le choix de les combattre ou non. Pensez à sauvegarder souvent ! Je ne compte plus le nombre de fois où je m'attendais à des ennemis faibles qui s'avéraient finalement être des cohortes ! L'humour aussi est au rendez-vous, le lore important si on souhaite s'y intéresser fortement, le monde cohérent. Et chose assez rare à souligner, le jeu est sorti en 2008 et le dernier patch date d'avril 2026 ! Rares sont les développeurs autant à l'écoute de leur communauté. Un titre terriblement addictif : une fois découvert, vous ne le laisserez plus jamais de côté !" },
  ...
  { year:2009, slug:"dragon-age-origins",
    ...
    opinion:"Il n'y a pas que les JRPG dans la vie : il y a aussi les RPG occidentaux ! Et celui auquel j'ai consacré le plus d'heures, j'ai nommé Dragon Age : Origins ! Annoncé avant le rachat par EA et sorti deux ans après ce dernier, ce jeu fait malheureusement partie des derniers de l'âge d'or de BioWare. Le lore est conséquent, et les six histoires d'origine distinctes modifient le prologue et imprègnent le reste du jeu. Ce qui marque en premier est le ton mature du jeu, et sa profonde liberté de choix : intrigues politiques, dilemmes moraux, romances libres… Rares sont les jeux aussi ouverts ! Le système de combat reprend le principe du pause-and-play hérité de Baldur's Gate de manière efficace et plus accessible. Combiné sur PC avec la vue tactique, on se retrouve avec un jeu à la fois dynamique et tactique. On retrouve également une galerie mémorable de compagnons d'infortune (Leliana !), avec une écriture irréprochable et des relations évoluant avec nos actions. C'est aussi un des derniers jeux où j'ai pu consacrer autant de temps (130h de jeu !), à guider mon Elfe des cités sur les terres de Ferelden. La suite de la série s'est tournée principalement sur l'action, perdant au passage ce mélange des genres qui fait de Dragon Age : Origins un jeu à part dans ma ludothèque. Dommage !"},
  ...
  { year:2012, slug:"spec-ops-the-line",
    ...
    opinion:"Étant atteint de cinétose (ou motion sickness), je ne peux tout simplement pas jouer aux FPS de manière agréable. Ma liste en comporte donc peu, et par ricochet peu de jeux dits de guerre. Certes, j'ai joué à des jeux de stratégie dans des conflits (Alerte rouge 2, Company of Heroes), mais rarement à la place même du soldat, là où le FPS excelle justement. Un sujet fascinant, mais que j'ai toujours trouvé mal traité. On retrouve généralement le gentil et le méchant, le soldat américain invincible contre tout un tas d'ennemis désespérément prévisibles. Bref, un gameplay peut-être intéressant, mais une histoire faiblarde, là où des films comme Apocalypse Now ou le premier Rambo parlent de la guerre au niveau du soldat, sans artifice ni patriotisme. Et un jour, je découvre Spec Ops : The Line, un TPS qui m'a enfin permis d'aborder ce thème. Ce jeu, malgré un gameplay qui peut sembler classique, offre une expérience qui nous fait réfléchir sur nos propres actes, en tant que joueur derrière la manette. Le capitaine Martin Walker évolue réellement par nos actions et la fin nous appartient. Ce jeu frappe fort, sa durée de vie est courte mais l'expérience est intense, nous rappelant que la guerre, c'est sale. Nul besoin de citer la scène qui a fait la réputation du jeu : tous ceux qui y ont joué savent très bien de quoi je parle. Et ça, c'est assez unique pour être signalé : nous avons tous vécu le même traumatisme. Bref, il faut avoir fait ce jeu au moins une fois dans sa vie. Aujourd'hui retiré des ventes en raison de problèmes de droits musicaux, le jeu mériterait une réédition un jour. Espérons-la."},
