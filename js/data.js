...
const GAMES = [
  ...
  // ── 1990 ──────────────────────────────────
  { year:1990, slug:"the-secret-of-monkey-island",
  ...
  { year:1994, slug:"woodruff-and-the-schnibble-of-azimuth",
  ...
  // ── 1997 ──────────────────────────────────
  { year:1997, slug:"broken-sword-2-the-smoking-mirror",
...
const ALTS = {
  // ── 1990 ──
  "the-secret-of-monkey-island":                        ["Monkey Island 2: LeChuck's Revenge (1991)", "Grim Fandango (1998)"],
  "actraiser":                                          ["ActRaiser 2 (1993)", "Populous: The Beginning (1998)"],
  // ── 1992 ──
  "indiana-jones-and-the-fate-of-atlantis":             ["The Dig (1995)", "Broken Sword 2 (1997)"],
  "super-mario-land-2-6-golden-coins":                  ["Wario Land: Super Mario Land 3 (1994)"],
  "kirbys-dream-land":                                  ["Kirby's Adventure (1993)", "Kirby: Nightmare in Dream Land (2002)"],
  "evo-search-for-eden":                                ["Spore (2008)"],
  // ── 1993 ──
  "ogre-battle-the-march-of-the-black-queen":           ["Ogre Battle 64 (1999)", "Tactics Ogre: Let Us Cling Together (1995)"],
  "day-of-the-tentacle":                                ["Full Throttle (1995)", "Grim Fandango (1998)"],
  "illusion-of-time":                                   ["Terranigma (1995)", "Secret of Mana (1993)"],
  // ── 1994 ──
  "theme-park":                                         ["Theme Hospital (1997)", "RollerCoaster Tycoon (1999)"],
  "wario-land-super-mario-land-3":                      ["Wario Land II (1998)", "Wario Land 4 (2001)"],
  "breath-of-fire-ii":                                  ["Breath of Fire III (1997)", "Breath of Fire IV (2000)"],
  "woodruff-and-the-schnibble-of-azimuth":              ["Deponia (2012)", "Syberia (2002)"],
  // ── 1995 ──
  "super-mario-world-2-yoshis-island":                  ["Yoshi's Island DS (2006)", "Yoshi's Crafted World (2019)"],
  "rayman":                                             ["Rayman 2: The Great Escape (1999)", "Rayman Origins (2011)"],
  "chrono-trigger":                                     ["Chrono Cross (1999)", "Radiant Historia (2010)"],
  "trials-of-mana":                                     ["Secret of Mana (1993)", "Visions of Mana (2024)"],
  "front-mission":                                      ["Front Mission 3 (1999)", "Into the Breach (2018)"],
  "tales-of-phantasia":                                 ["Tales of Symphonia (2003)", "Tales of Vesperia (2008)"],
  "terranigma":                                         ["Illusion of Time (1993)", "Soul Blazer (1992)"],
  // ── 1996 ──
  "wipeout-2097":                                       ["Wipeout 3 (1999)", "F-Zero X (1998)"],
  "donkey-kong-country-3-dixie-kongs-double-trouble":   ["Donkey Kong Country: Tropical Freeze (2014)"],
  // ── 1997 ──
  "broken-sword-2-the-smoking-mirror":                  ["Broken Sword: The Shadow of the Templars (1996)", "Syberia (2002)"],
  "age-of-empires":                                     ["Age of Empires II (1999)", "Age of Mythology (2002)"],
  "crash-bandicoot-2-cortex-strikes-back":              ["Crash Bandicoot 3: Warped (1998)", "Crash Bandicoot 4: It's About Time (2020)"],
  "oddworld-abes-oddysee":                              ["Oddworld: Abe's Exoddus (1998)", "Oddworld: Soulstorm (2021)"],
  "theme-hospital":                                     ["Theme Park (1994)", "Two Point Hospital (2018)"],
  // ── 1998 ──
  "the-legend-of-zelda-links-awakening-dx":             ["Link's Awakening Remake (2019)", "The Legend of Zelda: Oracle of Ages (2001)"],
  "suikoden-ii":                                        ["Suikoden (1995)", "Eiyuden Chronicle: Hundred Heroes (2024)"],
  "crash-bandicoot-3-warped":                           ["Crash Bandicoot N. Sane Trilogy (2017)"],
  "medievil":                                           ["MediEvil Remake (2019)", "Ghosts 'n Goblins Resurrection (2021)"],
  "the-settlers-iii":                                   ["The Settlers IV (2001)", "Anno 1602 (1998)"],
  "populous-the-beginning":                             ["Black & White (2001)", "Spore (2008)"],
  // ── 1999 ──
  "heroes-of-might-and-magic-iii-the-restoration-of-erathia": ["Heroes of Might and Magic V (2006)", "King's Bounty: The Legend (2008)"],
  "grandia":                                            ["Grandia II (2000)", "Star Ocean: The Second Story (1998)"],
  "chrono-cross":                                       ["Xenogears (1998)", "Lost Odyssey (2007)"],
  "metal-gear-solid-vr-missions":                       ["Metal Gear Solid 2: Sons of Liberty (2001)"],
  "civilization-call-to-power":                         ["Civilization III (2001)", "Civilization IV (2005)"],
  "worms-armageddon":                                   ["Worms World Party (2001)", "Worms W.M.D (2016)"],
  "ape-escape":                                         ["Ape Escape 2 (2002)", "Ape Escape 3 (2005)"],
  // ── 2000 ──
  "zeus-master-of-olympus":                             ["Pharaoh (1999)", "Caesar III (1998)"],
  "final-fantasy-ix":                                   ["Final Fantasy X (2001)", "Final Fantasy XII (2006)"],
  "command-conquer-red-alert-2":                        ["Command & Conquer: Red Alert 3 (2008)", "Tiberian Sun (1999)"],
  // ── 2001 ──
  "golden-sun":                                         ["Golden Sun: The Lost Age (2002)", "Baten Kaitos (2003)"],
  "baldurs-gate-dark-alliance":                         ["Champions of Norrath (2004)", "Diablo II (2000)"],
  "phoenix-wright-ace-attorney":                        ["Phoenix Wright: Ace Attorney — Trials and Tribulations (2004)", "The Great Ace Attorney Chronicles (2021)"],
  "max-payne":                                          ["Max Payne 2: The Fall of Max Payne (2003)", "Alan Wake (2010)"],
  "commandos-2-men-of-courage":                         ["Commandos 3: Destination Berlin (2003)", "Desperados III (2020)"],
  "arcanum-of-steamworks-and-magick-obscura":           ["Planescape: Torment (1999)", "Pillars of Eternity (2015)"],
  // ── 2002 ──
